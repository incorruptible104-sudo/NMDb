        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">
              ...
              <a href="/auth/signup" className="text-emerald-500 hover:text-emerald-400 transition">
                Sign up
              </a>
            </p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <a href="/auth/reset-password" className="text-xs text-gray-500 hover:text-gray-300 transition">
                  Forgot password?
                </a>
              </div>
              <input
